...
class Robot(object):
    ...
    def __init__(self, thresholds, gain = 10, p=1, i=0.05, d=0.9, imax=0.01):
        """
    ...
    def stage2(self, speed: float, bias: float) -> None:
        ...
        Args:
            ...
            bias (float): Just an example of other arguments you can add to the function!
        """
        '''Reasoning: follow the line,
        look for the obstacle
        if you see the obstacle stop
        when you dont see the obstacle anymore continue following the line'''
        while True:
...
if __name__ == "__main__":
    Thresholds =    [(25, 47, 15, 43, -8, 9), #Red
                    (17,27,-14,0,-8,16), #Obstacle
                    (14, 26, 5, 17, -32, -13), #Purple
                    (67, 77, -2, 18, -36, -18),
                    ]
    dude = Robot(Thresholds,2)
    dude.stage2(0.03,0)
