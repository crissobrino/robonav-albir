...
class Robot(object):
    ...
    def __init__(self, thresholds, gain = 10, p=1, i=0.05, d=0.9, p2=1, i2=0.05, d2=0.9, p3=1, i3=0.05, d3=0.9 , imax=0.01):
        """
...
if __name__ == "__main__":
    Thresholds =    [(20, 37, 12, 34, -12, 43), #Red
                    (7, 24, -26, -3, -10, 9), #Obstacle
                    (5, 14, 0, 17, -21, -6), #Purple
                    (23, 37, -15, 1, -16, -4),
                    ]
    dude = Robot(Thresholds,0)
    dude.stage100(0.03)
    # dude.debug(0)
